...
const handleRestock = async () => {
    ...
    try {
        ...
        await productService.updateProduct(restockTarget.id, {
            ...
            minStock: restockTarget.minStock ?? restockTarget.criticalStockThreshold ?? 5,
            criticalStockThreshold: restockTarget.criticalStockThreshold ?? restockTarget.minStock ?? 5,
            unit: restockTarget.unit || 'unité',
        })
        ...
        toast.error(err?.response?.data?.message || err.message || 'Failed to restock product')
    } finally {
